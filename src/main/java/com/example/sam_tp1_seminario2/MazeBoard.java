    ...
    public static MazeBoard from(String repr) {
        ...
        switch (repr) {
            ...
            case "[ 4 x 4 ]": {
                ...
                maze.board[6] = new BoardPiece(false, true, false, false);
                maze.board[7] = new BoardPiece(false, true, false, true);
                maze.board[8] = new BoardPiece(false, true, false, true);
                maze.board[9] = new BoardPiece(false, true, true, true);
                maze.board[10] = new BoardPiece(true, false, true, true);
                maze.board[11] = new BoardPiece(true, true, false, false);
                maze.board[12] = new BoardPiece(false, true, false, false);
                maze.board[13] = new BoardPiece(false, true, false, false);
                maze.board[14] = new BoardPiece(false, true, true, false);
                maze.board[15] = new BoardPiece(true, false, false, false);
                break;
            }
        }
        return maze;
